...
Java_com_haolin_gif_sample_GifNDKDecoder_loadGIFNative(JNIEnv *env, jclass type, jstring path_) {
...
Java_com_haolin_gif_sample_GifNDKDecoder_getWidth(JNIEnv *env, jclass type, jlong gifPointer) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_haolin_gif_sample_GifNDKDecoder_getHeight(JNIEnv *env, jclass type, jlong gifPointer) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_haolin_gif_sample_GifNDKDecoder_updateFrame(JNIEnv *env, jclass type, jobject bitmap,
                                               jlong gifPointer) {
    GifFileType *gifFileType = (GifFileType *) (gifPointer);
